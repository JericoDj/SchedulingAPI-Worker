...
const workerPortRaw = Number(process.env.WORKER_PORT || 4000);
const intervalMsRaw = Number(process.env.SCHEDULER_INTERVAL_MS || 60000);
const batchSizeRaw = Number(process.env.SCHEDULER_BATCH_SIZE || 10);
